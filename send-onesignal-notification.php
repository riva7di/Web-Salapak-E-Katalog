...
<?php
  ...
  if (isset($_POST['submit'])) {
        ...
        $_SESSION['msg'] = "Notifikasi berhasil dikirim";
...
<div id="content" class="pmd-content content-area dashboard">
    ...
    <div class="container-fluid full-width-container">
        ...
        <ol class="breadcrumb text-left">
          ...
          <li class="active">Kirim Notifikasi</li>
        </ol>
        <!--breadcrum end-->
        ...
        <div class="section"> 
            ...
            <div class="pmd-card pmd-z-depth">
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="lead">Kirim Notifikasi
                        </div>
                    </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group pmd-textfield">
                                <label for="regular1" class="control-label">Gambar ( jpg / png) *</label>
                ...
                <div class="pmd-card-actions">
                    <p align="right">
                    <button type="submit" class="btn pmd-ripple-effect btn-danger" name="submit">Kirim sekarang</button>
                    </p>
                </div>
