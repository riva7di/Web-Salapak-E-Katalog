				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">Edit Produk</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_price" class="control-label">Harga produk ( <?php echo $row_currency["currency_code"]; ?> ) *</label>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_quantity" class="control-label">Kualitas Produk *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">       
								...
								<select class="select-simple form-control pmd-select2" name="product_status">
									<option <?php if($row['product_status'] == 'Available'){ echo 'selected';} ?> value="Available">Tersedia</option>
									<option <?php if($row['product_status'] == 'Sold Out'){echo 'selected';} ?> value="Sold Out">Terjual habis</option>
								</select>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="regular1" class="control-label">Gambar produk ( jpg / png ) *</label>
