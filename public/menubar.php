...
<aside id="basicSidebar" class="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				<li><a href="add-category.php">+</a></li>
				<li><a href="manage-category.php">List Category</a></li>
		...
		<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				...
				<span class="media-body">Produk</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				<li><a href="add-product.php">+</a></li>
				<li><a href="manage-product.php">List Produk </a></li>
		...
		<li class="dropdown pmd-dropdown"> 
			...
			<ul class="dropdown-menu">
				<li><a href="add-notification.php">+</a></li>
				<li><a href="manage-notification.php">List Notification List</a></li>
		...
		<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				...
				<span class="media-body">Bantuan</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				<li><a href="add-help.php">+</a></li>
				<li><a href="manage-help.php">List bantuan</a></li>
		...
		<li> 
			<a class="pmd-ripple-effect" href="settings.php">	
				...
				<span class="media-body">Pengaturan</span>
			</a> 
		</li>
