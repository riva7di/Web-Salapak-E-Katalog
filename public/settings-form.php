                ...
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <br>
                            <button data-target="#currency-dialog" data-toggle="modal" class="btn pmd-btn-flat pmd-ripple-effect btn-primary" type="button">+</button>
                        </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield">
                                ...
                                <button data-target="#shipping-dialog" data-toggle="modal" class="btn pmd-btn-flat pmd-ripple-effect btn-primary" type="button">+</button>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header pmd-modal-bordered">
                                                ...
                                                <h2 class="pmd-card-title-text">Tambah Pengiriman</h2>
                                            </div>
                                            <form id="validationForm" method="post">            
                                            <div class="modal-body">
                                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                                        <label class="control-label">Nama Pengiriman</label>
