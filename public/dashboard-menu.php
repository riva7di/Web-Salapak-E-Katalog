...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="pmd-card pmd-z-depth">      
				...
				<div class="pmd-card-body">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" align="center">
						...
						<div class="source-semibold typo-fill-secondary">Proses</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" align="center">
						<div class="statistic-img-circle">
							<div data-badge="<?php echo $total_canceled; ?>" class="material-icons pmd-lg pmd-badge pmd-badge-overlap">cancel</div>
						</div>
						<div class="source-semibold typo-fill-secondary">Batal</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" align="center">
						<div class="statistic-img-circle">
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-title" align="center">
					<h1 class="pmd-card-title-text typo-fill-secondary propeller-title">Pengaturan</h1>
				</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-title" align="center">
					<h1 class="pmd-card-title-text typo-fill-secondary propeller-title">Tentang</h1>
				</div>
				<div class="pmd-card-body" align="center">
					<p>Web Admin ini di buat oleh seseorang yang sedang belajar membuat sebuah aplikasi </p>
					<br>
					<p><a href="https://www.instagram.com/m.rivaldiardiansyah/?hl=id" target="_blank">Instagram</a></p>
					<br>
					<p>279valdid@gmail.com</p>
				</div>
			</div>
		</div>
