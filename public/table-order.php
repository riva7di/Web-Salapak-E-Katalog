				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">Kelola Pesanan</div>
						</div>
					...
					<div class="table-responsive"> 
						...
						<br>
						<p align="center">whoops, Belum ada pesanan!</p>
						<br>
					</div>
				</div>
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="manage-order.php?id=<?php echo $data['id'];?>" onclick="return confirm('Yakin ingin menghapus pesanan ini secara permanen?')" >
